...
export const useTranslation = () => {
    ...
    const customT = useCallback(
        (key: string, defaultValueOrOptions?: string | Record<string, unknown>, options?: Record<string, unknown>) => {
    ...
    const language = (i18nInst.language?.slice(0, 2) || 'en') as Language;
    ...
    return useMemo(() => ({
        ...
        setLanguage,
        i18n: i18nInst
    }), [customT, language, setLanguage, i18nInst]);
};
