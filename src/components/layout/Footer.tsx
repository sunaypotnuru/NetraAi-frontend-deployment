...
export default function Footer() {
  ...
  return (
    <footer className="relative dark">
      {/* Wave Separator */}
      <div className="w-full overflow-hidden -mb-1">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
          <path d="M0,40 C360,100 720,0 1080,60 C1260,90 1380,70 1440,80 L1440,120 L0,120 Z" fill="url(#footerWaveGradient)" />
          <defs>
      ...
      <div className="bg-gradient-to-br from-[#1E293B] via-[#0F172A] to-[#0A0E1A] text-foreground backdrop-blur-sm bg-opacity-95">
                  ...
                  {links.map((link) => (
                    <li key={link.label}>
                      {link.path.startsWith('#') ? (
                        <a
                          href={link.path}
                          className="text-sm text-foreground no-underline hover:text-[#2DD4BF] transition-colors"
                        >
