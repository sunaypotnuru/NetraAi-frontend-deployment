  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-gradient-to-br from-[#F0FDFA] via-white to-[#F0F9FF]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="hero-float-1 absolute w-16 h-16 rounded-full bg-[#0D9488]/15 border border-[#0D9488]/20 backdrop-blur-[2px] shadow-inner top-[15%] left-[10%]" />
        <div className="hero-float-2 absolute w-24 h-24 rounded-full bg-[#0EA5E9]/15 border border-[#0EA5E9]/20 backdrop-blur-[2px] shadow-inner top-[60%] right-[8%]" />
        <div className="hero-float-3 absolute w-12 h-12 rounded-full bg-[#8B5CF6]/15 border border-[#8B5CF6]/20 backdrop-blur-[2px] shadow-inner top-[30%] right-[25%]" />
        <Heart className="hero-float-1 absolute w-8 h-8 text-[#F43F5E]/30 top-[20%] right-[15%]" />
        <Activity className="hero-float-2 absolute w-8 h-8 text-[#0D9488]/30 bottom-[25%] left-[15%]" />
        <Brain className="hero-float-3 absolute w-7 h-7 text-[#8B5CF6]/30 top-[45%] left-[25%]" />
        <Shield className="hero-float-1 absolute w-7 h-7 text-[#0EA5E9]/30 bottom-[35%] right-[20%]" />
      </div>
          ...
          <div className="z-10 hero-fade-in">
            ...
            <div className="relative flex flex-wrap gap-4 hero-slide-up" style={{ animationDelay: '0.4s' }}>
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-r from-[#0D9488] to-[#0EA5E9] rounded-full blur-3xl -z-10"
              />
              {user ? (
                <Button
                  size="lg"
          ...
          <div className="relative hidden lg:block hero-scale-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-[#0D9488]/20 to-transparent rounded-bl-full" />
              ...
              <div className="absolute -bottom-6 -right-6 w-full h-full bg-gradient-to-br from-[#0D9488]/20 to-[#0EA5E9]/20 rounded-3xl -z-10" />
            </div>
          </div>
        </div>
      </div>
