...
export default function MedicalHistoryPage() {
    ...
    if (isLoading) {
        return <HeartbeatLoader text={t('patient.history.loading', 'Syncing Clinical History...')} />;
    }
    ...
    const exportCSV = async () => {
        ...
        const worksheet = workbook.addWorksheet(t("patient.history.sheet_name", "History"));
        
        // Add headers
        worksheet.columns = [
            { header: t("common.date", "Date"), key: 'date', width: 15 },
            { header: t("common.type", "Type"), key: 'type', width: 20 },
            { header: t("common.doctor", "Doctor"), key: 'doctor', width: 20 },
            { header: t("common.summary", "Summary"), key: 'summary', width: 40 },
            { header: t("common.result", "Result"), key: 'result', width: 20 }
        ];
