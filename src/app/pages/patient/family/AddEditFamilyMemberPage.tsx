    ...
    return (
      <div className="min-h-screen pt-20 pb-10 bg-transparent flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">{t('patient.family.loading', "Loading...")}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen pt-20 pb-10 bg-transparent">
      <div className="max-w-3xl mx-auto px-4 space-y-6">
        ...
        >
          <Card className="p-8 bg-white/70 dark:bg-slate-900/50 backdrop-blur-md border border-slate-200/50 dark:border-white/10 shadow-xl transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2 border-b border-slate-100 dark:border-slate-800/80 pb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <Input
                      ...
                      required
                      className="bg-slate-50/50 dark:bg-slate-950/40 border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-teal-500 text-slate-900 dark:text-white"
                    />
                  </div>
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl border transition-all text-center flex flex-col items-center justify-center ${
                            relationship === option.value
                              ? 'bg-teal-50/80 dark:bg-teal-950/40 border-teal-500 dark:border-teal-400 shadow-md scale-98'
                              : 'bg-slate-50/30 dark:bg-slate-950/20 border-slate-200 dark:border-slate-800 hover:border-teal-300 dark:hover:border-teal-800'
                          }`}
                        >
                          <div className="text-2xl mb-1 filter drop-shadow-sm">{option.icon}</div>
                          <p className={`text-sm font-semibold ${
                            relationship === option.value ? 'text-teal-700 dark:text-teal-400' : 'text-slate-700 dark:text-slate-300'
                          }`}>
                            {option.label}
                          </p>
                        </button>
                  ...
                  <div>
                    <Label className="text-sm font-semibold text-slate-700 dark:text-slate-350 mb-2 flex items-center gap-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          className="w-full justify-start text-left font-normal bg-slate-50/50 dark:bg-slate-950/40 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white rounded-xl"
                        >
                          <CalendarIcon className="mr-2 h-4 w-4 text-slate-400" />
                          {format(dateOfBirth, "PPP")}
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="w-auto p-0 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl" align="start">
                        <Calendar
                          mode="single"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-50/50 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-slate-900 dark:text-white transition-all duration-300"
                      required
                    >
              ...
              <div className="space-y-4">
                ...
                <Card className="p-5 bg-slate-50/50 dark:bg-slate-950/40 border-slate-200/50 dark:border-slate-800 rounded-xl shadow-inner">
                  <div className="space-y-5">
                    <div className="flex items-start gap-3">
                      <Checkbox
                        ...
                        className="mt-0.5 border-slate-300 dark:border-slate-700 text-teal-600 focus:ring-teal-500"
                      />
              ...
              <div className="flex gap-3 pt-6 border-t border-slate-100 dark:border-slate-800/80">
                <Button
                  ...
                  variant="outline"
                  onClick={() => navigate("/patient/family")}
                  className="flex-1 border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 rounded-xl"
                  disabled={isSaving}
                >
                ...
                <Button
                  type="submit"
                  className="flex-1 bg-teal-600 hover:bg-teal-700 text-white gap-2 rounded-xl shadow-md transition-all duration-300"
                  disabled={isSaving}
                >
                  {isSaving ? (
                    <>
