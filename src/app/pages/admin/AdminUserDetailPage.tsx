...
export default function AdminUserDetailPage() {
  ...
  const { data: userData, isLoading } = useQuery({
    ...
    queryFn: () => adminAPI.getPatient(id!).then(res => res.data), // This should really be a generic get user, but getPatient works for patients
    enabled: !!id
  });
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#0F172A] mb-2">
                {user.profile?.full_name || user.profile?.name || 'User Detail'}
              </h1>
              <p className="text-[#64748B]">{user.profile?.email}</p>
            </div>
          </div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to delete {user.profile?.full_name || user.profile?.name}? 
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-[#0F172A] font-medium mt-1">{user.profile?.full_name || user.profile?.name}</p>
                        )}
                      </div>
                    </div>
