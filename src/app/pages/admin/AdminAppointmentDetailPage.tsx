...
export default function AdminAppointmentDetailPage() {
    ...
    if (!responseData || !responseData.appointment) {
        return (
    ...
    const { appointment, patient, doctor } = responseData;

    const patientName = patient?.full_name || t("common.unknown_patient", "Unknown Patient");
    const patientEmail = patient?.email || t("common.na", "N/A");
    const doctorName = doctor?.full_name || t("common.unknown_doctor", "Unknown Doctor");
    const doctorSpecialty = doctor?.specialty || t("common.na", "N/A");
    ...
    const consultationFee = doctor?.consultation_fee ? `₹${doctor.consultation_fee}` : t("common.na", "N/A");
