                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-muted/50 rounded-xl">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">{t("admin.settings.security.two_fa_desc", "Require 2FA for all admin accounts")}</p>
                        </div>
                        <button
                    ...
                    <Card className="p-4 border border-blue-100 bg-blue-50/40">
                        ...
                        {enrollQr && (
                            <div className="mt-4 grid md:grid-cols-2 gap-4 items-start">
                                <div className="bg-white rounded-xl p-3 border border-blue-100">
                                    <p className="text-xs font-semibold text-foreground">{t('admin.settings.security.scan_qr', 'Scan QR')}</p>
                        ...
                        <div className="mt-4">
                            <p className="text-xs font-semibold text-foreground">{t('admin.settings.security.current_factors', 'Current factors')}</p>
                            {mfaLoading ? (
                                <p className="text-xs text-muted-foreground mt-1">{t('common.loading', 'Loading...')}</p>
                            ) : factors.length === 0 ? (
                                <p className="text-xs text-muted-foreground mt-1">{t('admin.settings.security.no_factors', 'No factors enrolled yet.')}</p>
                            ) : (
                                    ...
                                    {factors.map((f) => (
                                        <div key={f.id} className="flex items-center justify-between gap-2 bg-white border border-blue-100 rounded-lg px-3 py-2">
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-[11px] text-muted-foreground truncate">{f.status || 'unknown'}</p>
                                            </div>
                    ...
                    <div className="p-4 bg-muted/50 rounded-xl">
                        <p className="font-semibold text-foreground mb-2">{t("admin.settings.security.session_timeout", "Session Timeout (minutes)")}</p>
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <div key={envKey} className="space-y-1">
                            ...
                            <p className="text-xs text-muted-foreground">{t("admin.settings.api.env_desc_1", "Set in ")}<code className="bg-gray-100 px-1 rounded">.env</code>{t("admin.settings.api.env_desc_2", " as ")}<code className="bg-gray-100 px-1 rounded">{envKey}</code></p>
                        </div>
                    ))}
            ...
            panel: (
                <div className="space-y-4">
                    <div className="space-y-1">
                        <p className="font-semibold text-foreground flex items-center gap-2"><Clock className="w-4 h-4" />{t("admin.settings.system.timezone", "Timezone")}</p>
                    ...
                    <div className="space-y-1">
                        <p className="font-semibold text-foreground flex items-center gap-2"><Globe className="w-4 h-4" />{t("admin.settings.system.currency", "Currency")}</p>
            ...
            panel: (
                <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2">
                    <div className="space-y-3">
                        <p className="font-semibold text-foreground">{t("admin.settings.public.social", "Social Links")}</p>
                    ...
                    <div className="space-y-3 pt-4 border-t border-gray-100">
                        <div className="flex items-center justify-between">
                            <p className="font-semibold text-foreground">{t("admin.settings.public.team", "Team Members")}</p>
                        ...
                        {platform.team_members.map((member, idx) => (
                            <div key={idx} className="p-3 bg-muted/50 border border-gray-100 rounded-lg space-y-2 relative">
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">{t("admin.settings.page_subtitle", "Manage global configuration and security preferences")}</p>
            </div>
