...
export default function HealthRiskAssessmentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const score = calculateClinicalRiskScore();
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                            ...
                            {history.length > 0 ? (
                                ...
                                <div className="h-48 flex flex-col items-center justify-center text-gray-400 dark:text-gray-500 text-center">
                                    ...
                                    <p className="text-xs" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(t('patient.hra.no_assessments', 'No assessments recorded yet.<br />Fill out the form to generate your first score.')) }}></p>
                                </div>
                            )}
                        </div>
