...
export default function NotificationSettingsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen pt-3 pb-12 px-6 bg-gradient-to-br from-[#F0FDFA] via-white to-[#F8FAFC] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
