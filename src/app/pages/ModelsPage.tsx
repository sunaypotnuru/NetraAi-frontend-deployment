...
export default function ModelsPage() {
  ...
  return (
    <div className="min-h-screen pt-20 pb-16 px-4 sm:px-6 bg-background">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-card/80 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-border/50 shadow-sm">
  ...
  className={`p-6 cursor-pointer border border-border bg-gradient-to-br from-${model.color}10 to-${model.color}20 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group h-full flex flex-col`}
>
                {/* Icon */}
                <div
